...
if response.status_code == 200:
    ...
    if mac_liste_div:
        ...
        for mac in mac_divler:
            ...
            # EXTINF satırı
            extinf = f"#EXTINF:-1 tvg-name=\"beIN SPORTS 1\" tvg-language=\"Turkish\" tvg-country=\"TR\" tvg-id=\"Spor_beINSPORTS\" tvg-logo=\"https://r2.thesportsdb.com/images/media/channel/logo/5rhmw31628798883.png\" group-title=\"Spor\",{saat} {takimlar}"
            # Veriyi formatla

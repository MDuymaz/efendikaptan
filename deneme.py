...
# 30 dakikada bir siteyi kontrol et ve verileri al
while True:
    print("Veri çekmeye başlıyorum...")
    fetch_data()  # Siteyi kontrol et ve verileri al
    print("30 dakika bekleniyor...")
    time.sleep(1800)  # 30 dakika bekle (1800 saniye)
